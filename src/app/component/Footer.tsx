      ...
      <ContentWrapper>
        ...
        <div className="flex justify-between items-center">
          <div className="w-64 flex flex-col gap-4">
            <span className="dark:text-white flex flex-col gap-4">
              About
          ...
          <div className="flex flex-col gap-8 justify-center items-center bg-custom_gray_colors p-4 rounded-lg">
            <div className="dark:text-white text-[14px]">
              <p className="text-center">Weekly Newsletter</p>
              <p className="dark:text-custom_text_grey_color">Subscribe to our weekly newsletter</p>
            </div>
            <div className="flex flex-col gap-1">
              <input type="text" placeholder="Your Email" className="w-60 h-9 border border-gray-700 rounded-md outline-none pl-3 text-[12px] bg-custom_footer_colors dark:text-white" />
              <button className="dark:text-white bg-custom_blue_colrs h-9 rounded-md text-[12px]">subscribe</button>
            </div>
          </div>
        </div>
          
        <div className="empty_border border border-b-0 border-gray-800  mb-4"></div>
        <div className="flex justify-between items-center">
          ...
          <div className="flex dark: text-gray-500 text-[14px] gap-3 justify-center ">    
            <p>Term of Use</p>
            <div className="empty_border border border-r-0 border-gray-800   w-0 h-auto"></div>
            <p>Term of Use</p>
            <div className="empty_border border border-r-0 border-gray-800  w-0 h-auto"></div>
            <p>Term of Use</p>
          </div>
